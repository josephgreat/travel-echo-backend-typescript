...
exports.LikeModel = exports.Like = exports.LikeTarget = void 0;
...
__decorate([
    (0, typegoose_1.prop)({ required: false, ref: () => post_model_1.Post }),
    __metadata("design:type", mongoose_1.default.Types.ObjectId)
], Like.prototype, "post", void 0);
__decorate([
    (0, typegoose_1.prop)({ required: false, ref: () => comment_model_1.Comment }),
    __metadata("design:type", mongoose_1.default.Types.ObjectId)
], Like.prototype, "comment", void 0);
__decorate([
    (0, typegoose_1.prop)({ required: true, enum: LikeTarget }),
